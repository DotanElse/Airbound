...
public class GameConstants {
    ...
    public static final int BALL_GRAVITY_FACTOR = 3;
    public static final int MAX_PUSH_STRENGTH = 300;
    public static final float BALL_FRICTION = 0.02f;
    ...
    public static final int CONTINUE_BUTTON_SIZE = 400;
    public static final int SOUND_TOGGLE_BUTTON_SIZE = 50;
